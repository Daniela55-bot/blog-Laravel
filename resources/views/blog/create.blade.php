...
<html lang="en">
  ...
  <img src="{{ asset('imagen/blog3.jpg') }}" width="1350" height="350" >
  ...
  <div class="row row-cols-1 row-cols-md-3 g-4">
    <div class="col">
      <div class="card">
        <img src="{{ asset('imagen/noticia2.png') }}" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="col">
      <div class="card">
        <img src="{{ asset('imagen/noticia1.png') }}" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="col">
      <div class="card">
        <img src="{{ asset('imagen/noticia3.png') }}" class="card-img-top" alt="...">
        <div class="card-body">
...
<div class="row row-cols-1 row-cols-md-3 g-4">
    <div class="col">
      <div class="card">
        <img src="{{ asset('imagen/noticia4.png') }}" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="col">
      <div class="card">
        <img src="{{ asset('imagen/noticia6.png') }}" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="col">
      <div class="card">
        <img src="{{ asset('imagen/noticia5.png') }}" class="card-img-top" alt="...">
        <div class="card-body">
...
<div class="row row-cols-1 row-cols-md-3 g-4">
    <div class="col">
      <div class="card">
        <img src="{{ asset('imagen/noticia7.png') }}" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="col">
      <div class="card">
        <img src="{{ asset('imagen/noticia8.jpg') }}" class="card-img-top"  alt="...">
        <div class="card-body">
    ...
    <div class="col">
      <div class="card">
        <img src="{{ asset('imagen/noticia9.jpg') }}" class="card-img-top"alt="...">
        <div class="card-body">
